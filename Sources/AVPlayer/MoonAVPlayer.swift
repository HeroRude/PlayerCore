...
import Combine
import CoreGraphics
public final class MoonAVPlayerView: UIView {
...
public class MoonAVPlayer {
    ...
    private let playerView = MoonAVPlayerView()
    ...
    private lazy var _pipController: Any? = {
        if #available(tvOS 14.0, *) {
            let pip = MoonPictureInPictureController(playerLayer: playerView.playerLayer)
            return pip
        } else {
            return nil
        }
...
extension MoonAVPlayer: MediaPlayerProtocol {
