...
class MEFilter {
    ...
    public init(timebase: Timebase, isAudio: Bool, nominalFrameRate: Float, options: MoonOptions) {
    ...
    public func filter(options: MoonOptions, inputFrame: UnsafeMutablePointer<AVFrame>, completionHandler: (UnsafeMutablePointer<AVFrame>) -> Void) {
        let filters: String
        if isAudio {
