...
class PixelBuffer: PixelBufferProtocol {
    ...
    init(frame: AVFrame) {
        ...
        colorspace = MoonOptions.colorSpace(ycbcrMatrix: yCbCrMatrix, transferFunction: transferFunction)
        ...
        formats = MoonOptions.pixelFormat(planeCount: planeCount, bitDepth: bitDepth)
