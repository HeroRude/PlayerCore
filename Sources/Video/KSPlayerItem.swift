...
public class KSPlayerResource: Equatable, Hashable {
     ...
     */
    public convenience init(url: URL, options: MoonOptions = MoonOptions(), name: String = "", cover: URL? = nil, subtitleURLs: [URL]? = nil, extinf: [String: String]? = nil) {
...
public struct KSPlayerResourceDefinition: Hashable {
     ...
     */
    public init(url: URL, definition: String, options: MoonOptions = MoonOptions()) {
        self.url = url
